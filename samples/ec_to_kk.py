...
from KoikatuCharaData import KoikatuCharaData, Coordinate
from EmocreCharaData import EmocreCharaData

def main():
    ec = EmocreCharaData.load("./datas/ec_chara.png")
    kk = KoikatuCharaData()
    ...
    items = ["animal", "eat", "cook", "exercise", "study", "fashionable", "blackCoffee", "spicy", "sweet"]
    ...
    items = ["hinnyo", "harapeko", "donkan", "choroi", "bitch", "mutturi", "dokusyo", "ongaku", "kappatu",
                "ukemi", "friendly", "kireizuki", "taida", "sinsyutu", "hitori", "undo", "majime", "likeGirls"]
    ...
    kk.save("./datas/kk_chara_converted.png")
